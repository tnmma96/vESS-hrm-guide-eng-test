...
![](picture/PIC_DW_Timesheets-QuyTrinh.png)
...
* Báo cáo theo theo công việc. Chi tiết nghiệp vụ <u>[tại đây](#bao-cao-theo-cong-viec)</u>.
...
![](picture/PIC_DW_Timesheets-Menu.png)
    ...
    * **Ghi chú**: Người dùng có thể quản lý Thời gian biểu tại chức năng **Dự án**, chọn **Dự án/Task**. Chọn **Nhiệm vụ** thuộc dự án, nhấn **Timesheet/Thêm một dòng**
    ...
    ![](picture/PIC_DW_DuAn-TaoLogwork.png)
    
2. Khai báo các thông tin chi tiết của **Thời gian làm việc:**
![](picture/PIC_DW_Timesheets-Tao.png)
...
![](picture/PIC_DW_Timesheets-TatCaThoiGianLamViec.png)
...
![](picture/PIC_DW_Timesheets-BCTheoNV.png)
...
2. Người dùng thực hiện thay đổi dữ liệu cần thống kê theo nhu cầu (nếu có)
    ...
    * Chọn **- Tổng** để loại bỏ điều kiện thống kê hiện tại theo hàng hoặc cột
    ...
    ![](picture/PIC_DW_Timesheets-XoaBoLoc.png)
    
    * Chọn **+ Tổng** để tạo mới điều kiện thống kê báo cáo theo hàng hoặc cột
    
    ![](picture/PIC_DW_Timesheets-TaoBoLoc.png)
...
![](picture/PIC_DW_Timesheets-BCTheoDuAn.png)
...
![](picture/PIC_DW_Timesheets-BCTheoCongViec.png)
...
![](picture/PIC_DW_Timesheets-CauHinh.png)
